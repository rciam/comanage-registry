...
class CoOrgIdentityLink extends AppModel {
  ...
  /**
   * Actions to take after a Delete action is executed.
   *
   * @since  COmanage Registry v3.1.0
   */

  public function afterDelete() {
    if(isset($_SESSION["OrgIdentityExpunge"])
       && $_SESSION["OrgIdentityExpunge"] == true) {
      unset($_SESSION["OrgIdentityExpunge"]);
      $org_identity_id = $this->field('org_identity_id');
      $this->OrgIdentity->delete($org_identity_id);
